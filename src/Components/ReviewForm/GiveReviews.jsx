...
function GiveReviews({ doctorName, specialty, date, onClose }) {
        ...
        <div className="review-form-container">
            ...
            <div className="consultation-info">
                ...
                <div className="consultation-details">
                    <h3 className="consultation-doctor">{doctorName || "Dr. Sarah Johnson"}</h3>
                    <p className="consultation-specialty">{specialty || "General Physician"}</p>
                    <p className="consultation-date">
                        Consultation Date: {date || new Date().toLocaleDateString()}
                    </p>
                </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="review-form">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" id="name" name="name"
                            className="review-input" placeholder="Enter your name"
                    ...
                    <div className="form-group">
                        ...
                        <textarea id="review" name="review"
                            ...
                            value={formData.review} onChange={handleChange} rows={4} />
                    </div>
                    <div className="review-btn-group">
                        <button type="submit" className="submit-review-btn">Submit</button>
                        <button type="button" className="cancel-review-btn"
